      ...
      <div className="relative z-10">
        ...
        <div className="max-w-7xl mx-auto px-4 py-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-8 slide-up">
            {[
              { label: 'Total Anggota', value: totalAnggota ?? 0, icon: '👥', badgeClass: 'badge-tech-blue' },
              { label: 'Total Event', value: totalEvent ?? 0, icon: '📅', badgeClass: 'badge-tech-amber' },
              { label: 'Total Absensi', value: totalAbsensi ?? 0, icon: '✅', badgeClass: 'badge-open' },
            ].map((stat) => (
          ...
          <div className="grid md:grid-cols-3 gap-4 mb-8 slide-up">
            <Link
              ...
              className="tech-card tech-card-hover p-5 border border-cyan-500/30 hover:glow-blue transition-all group flex items-center gap-4"
            >
              <div className="w-12 h-12 rounded-2xl bg-cyan-600/20 border border-cyan-500/40 flex items-center justify-center text-2xl group-hover:scale-110 transition-transform">
                📷
              </div>
              <div>
            ...
            <Link
              ...
              className="tech-card tech-card-hover p-5 border border-blue-500/30 hover:glow-blue transition-all group flex items-center gap-4"
            >
              <div className="w-12 h-12 rounded-2xl bg-blue-600/20 border border-blue-500/40 flex items-center justify-center text-2xl group-hover:scale-110 transition-transform">
                ➕
              </div>
              <div>
            ...
            <Link
              ...
              className="tech-card tech-card-hover p-5 border border-amber-500/30 hover:glow-amber transition-all group flex items-center gap-4"
            >
          ...
          <div className="tech-card p-6 border border-blue-500/20 slide-up">
            <div className="flex items-center justify-between mb-4">
              ...
              <Link href="/portal-it-admin/events" className="text-blue-400 hover:text-blue-300 text-xs font-bold transition-colors">
                Lihat Semua →
              </Link>
            </div>
